...
1. Download the following 2 files into your download folder:
  * [**SuccessFactors Source**](content/configure_identity_provisioning/files/SuccessFactors-SF-Company-ID-Joule.json ':ignore :target=_self')
  * [**WorkZone Target**](content/configure_identity_provisioning/files/WorkZone_Target_ForJoule.json ':ignore :target=_self')
...
3. Authenticate using an administrator user.                 
![configure_ips](0-1.jpg)

4. From the menu, access **Identity Provisioning >> Source Systems**.
![configure_ips](2.jpg)

5. Under **Source Systems** click **+Add** icon.
![configure_ips](3.jpg)

6. Click **Browse** to import a pre-defined source system configuration.
![configure_ips](4.jpg)

7. Select the **SuccessFactors-SF-Company-ID-Joule.json** file downloaded earlier and click **Open**.

8. Update the **System Name** field and put in your SuccessFactors system company ID and click **Save**.
![configure_ips](5.jpg)
